...
export const PersonRoleArray = Object.keys(PersonRoleObj) as IPersonRole[] & [string, ...string[]];
export const PersonRoleSelection = PersonRoleArray.map((key) => ({ label: PersonRoleObj[key], value: key }))