...
export const ActivityTypeArray = Object.keys(ActivityTypeObj) as IActivityType[] & [string, ...string[]];
...
export const ActivityActionArray = Object.keys(ActivityActionObj) as IActivityAction[] & [string, ...string[]];
