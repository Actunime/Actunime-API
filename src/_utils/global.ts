...
import type { IUpdate } from "../_types/updateType";
...
export type ITargetPathType<T extends ITargetPath> =
  T extends "User" ? IUser :
  T extends "Groupe" ? IGroupe :
  T extends "Manga" ? IManga :
  T extends "Anime" ? IAnime :
  T extends "Character" ? ICharacter :
  T extends "Person" ? IPerson :
  T extends "Track" ? ITrack :
  T extends "Company" ? ICompany :
  T extends "Update" ? IUpdate :
  T extends "Activity" ? IActivity :
  T extends "Report" ? IReport :
  T extends "DisabledUser" ? IUser :
  T extends "PremiumUser" ? IUser :
  any;