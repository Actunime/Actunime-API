import { CharacterGenderArray, CharacterRoleArray, CharacterSpeciesArray } from "../_utils/characterUtil";
import { z } from "zod";
...
export const Create_Character_ZOD = z.object({
...
export const CharacterDataToZOD = (data: ICharacter): Partial<ICreate_Character_ZOD> => {
  ...
  let toZOD: Partial<ICreate_Character_ZOD> = {
    name: data.name,
    age: data.age,
  ...
  let safeParse = Create_Character_ZOD.safeParse(toZOD);
