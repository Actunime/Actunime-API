...
export const Create_Person_ZOD = z.object({
...
export type IAdd_Person_ZOD = z.infer<
  typeof Add_Person_ZOD
>;
...
export const PersonDataToZOD = (data: IPerson): Partial<ICreate_Person_ZOD> => {
  ...
  let toZOD: Partial<ICreate_Person_ZOD> = {
    name: data.name,
  ...
  let safeParse = Create_Person_ZOD.safeParse(toZOD);
